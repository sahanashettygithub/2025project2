        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block">
            <div className="relative">
              <div className="absolute -top-10 -left-10 w-72 h-72 bg-eco-accent/20 rounded-full filter blur-3xl"></div>
              <div className="absolute -bottom-10 -right-10 w-72 h-72 bg-eco-water/20 rounded-full filter blur-3xl"></div>
              <div className="relative z-10 grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl overflow-hidden shadow-lg animate-float" style={{ animationDelay: '0.5s' }}>
                    <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb" alt="Nature" className="w-full h-64 object-cover" />
                  </div>
                </div>
                <div className="space-y-4 mt-8">
                  <div className="rounded-xl overflow-hidden shadow-lg animate-float" style={{ animationDelay: '1s' }}>
                  ...
                  <div className="rounded-xl overflow-hidden shadow-lg animate-float" style={{ animationDelay: '1.5s' }}>
