        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-xl">
            ...
            <AnimatedElement variant="fade-up" delay={0.6}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/donate">
                  <Button className="bg-eco-primary hover:bg-eco-dark py-6 px-8 text-lg flex gap-2 w-full sm:w-auto justify-center hover:scale-105 transition-transform">
                    <Gift className="h-5 w-5" />
                    <span>Donate Now</span>
                  </Button>
                </Link>
                <Link to="/sell">
                  <Button variant="outline" className="border-eco-primary text-eco-primary hover:bg-eco-light py-6 px-8 text-lg flex gap-2 w-full sm:w-auto justify-center hover:scale-105 transition-transform">
          ...
          <div className="hidden lg:block">
            <div className="relative">
              <div className="absolute -top-10 -left-10 w-72 h-72 bg-eco-accent/20 rounded-full filter blur-3xl animate-pulse"></div>
              <div className="absolute -bottom-10 -right-10 w-72 h-72 bg-eco-water/20 rounded-full filter blur-3xl animate-pulse" style={{animationDelay: "1s"}}></div>
              <div className="relative z-10 grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <AnimatedElement variant="fade-right" delay={0.3}>
                  ...
                  <AnimatedElement variant="fade-right" delay={0.5}>
                    <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="space-y-4 mt-8">
                  <AnimatedElement variant="fade-left" delay={0.7}>
                    <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <AnimatedElement variant="fade-left" delay={0.9}>
                    <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
